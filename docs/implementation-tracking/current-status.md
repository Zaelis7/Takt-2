...
| Arbeitspakete | 106 | 36 implemented, 68 planned, 0 in progress, 2 durch dokumentierte Entscheidungen blockiert |
...
1. `IAM-039`, `IAM-040`, `IAM-041`, `IAM-013`: auf der implementierten API-Token-Akteurparität folgen Application-Schreiborchestrierung, Create- und Patch/Revoke-HTTP sowie abschließend die Produktionskomposition.
