...
| Arbeitspakete | 107 | 37 implemented, 68 planned, 0 in progress, 2 durch dokumentierte Entscheidungen blockiert |
...
1. `IAM-042`, `IAM-040`, `IAM-041`, `IAM-013`: auf der implementierten Create-Orchestrierung folgen Patch/Revoke-Application, Create- und Patch/Revoke-HTTP sowie abschließend die Produktionskomposition.
