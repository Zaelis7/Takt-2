...
| Arbeitspakete | 96 | 28 implemented, 66 planned, 0 in progress, 2 durch dokumentierte Entscheidungen blockiert |
...
1. `IAM-025`, danach `IAM-013`: frameworkfreie CRUD-/Bearer-Use-Cases und anschließend die OpenAPI-konforme HTTP-Runtime umsetzen.
