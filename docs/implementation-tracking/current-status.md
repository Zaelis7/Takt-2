...
| Arbeitspakete | 96 | 27 implemented, 67 planned, 0 in progress, 2 durch dokumentierte Entscheidungen blockiert |
...
1. `IAM-028`: atomare Revoke-Idempotenz auf der Patch-Grundlage aus `IAM-026` ergänzen.
